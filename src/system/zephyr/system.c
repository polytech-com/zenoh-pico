...
#ifdef CONFIG_ZENOH_PICO_STACK_SIZE
#define Z_PTHREAD_STACK_SIZE_BASE CONFIG_ZENOH_PICO_STACK_SIZE
#else
#define Z_PTHREAD_STACK_SIZE_BASE CONFIG_MAIN_STACK_SIZE
#endif

#ifdef CONFIG_TEST_EXTRA_STACK_SIZE
#define Z_PTHREAD_STACK_SIZE_DEFAULT Z_PTHREAD_STACK_SIZE_BASE + CONFIG_TEST_EXTRA_STACK_SIZE
#elif CONFIG_TEST_EXTRA_STACKSIZE
#define Z_PTHREAD_STACK_SIZE_DEFAULT Z_PTHREAD_STACK_SIZE_BASE + CONFIG_TEST_EXTRA_STACKSIZE
#else
#define Z_PTHREAD_STACK_SIZE_DEFAULT Z_PTHREAD_STACK_SIZE_BASE
#endif
